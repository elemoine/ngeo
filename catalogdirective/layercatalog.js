...
/**
 * A function that returns a layer for a type. A cache is used, so always the
 * same layer instance is returned for a given layer type. This function is
 * used as the `ngeoLayer
